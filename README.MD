...
Social login api for angular 15 . Includes Facebook, Google and Linkedin. 
...
```sh
npm install --save angular-15-social-login-updated
```
...
} from "angular-15-social-login-updated";
